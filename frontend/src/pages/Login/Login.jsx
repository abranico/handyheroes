  ...
  return (
    <div className="max-w-md mx-auto flex items-center flex-col justify-center h-screen">
      <header className="flex flex-col w-full">
        ...
        <h2 className="font-bold text-4xl text-gray-600">Continúe con su cuenta</h2>
      </header>
      <main className="w-full">
        <form className="mt-12 w-full">
          <div className="mb-4 w-full">
            <input type="email" id="email" placeholder="Correo Electrónico" className="appearance-none border border-gray-300 rounded w-full py-4 px-3 leading-tight focus:outline-none focus:border-gray-500  text-gray-700" />
          </div>
          <div className="mb-4 relative">
            <input type="password" id="password" placeholder="Contraseña" className="appearance-none border border-gray-300 rounded w-full py-4 px-3 leading-tight focus:outline-none focus:border-gray-500  text-gray-700 pr-10" />
